...
import { Activity, BarChart3, KeyRound, LogOut, MessageSquare, ScanLine, Settings, Users } from "lucide-react";
    ...
    <main className="admin-shell">
      <aside className="sidebar admin-sidebar">
        ...
        <nav className="nav-stack">
          ...
          <NavLink to="/admin/configuration"><Settings size={18} />Configuration</NavLink>
